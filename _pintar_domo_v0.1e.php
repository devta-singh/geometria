...
<br><input type="checkbox" name="rotacion" value="1" $chk_rotacion /> Rotar niveles <input type="text" name="angulo_rotacion" value="$angulo_rotacion" size="5"/> grados
